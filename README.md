...
[Origin](#-origin--philosophy) • [Features](#-features) • [Installation](#-installation) • [Self-Hosting](#-self-hosting) • [Disclaimer](#%EF%B8%8F-disclaimer)
...
**Watchwyrd** combines:
- **Watch** — the act of viewing content
- **Wyrd** — the Old English/Norse concept of fate and destiny

The brand sits at the intersection of **mysticism** and **cutting-edge AI technology** — intelligent, personalized, and a little bit magical.
...
- **🌤️ Weather-based mood matching** - Set your city for local weather integration
...
| Profile | Best For |
|---------|----------|
| 🎬 **Casual** | Mainstream entertainment, popular picks |
| 🎥 **Cinephile** | Critics' favorites, hidden gems, all eras |
| 👨‍👩‍👧‍👦 **Family** | Kid-friendly content, PG-13 max |
| 📺 **Binge Watcher** | Series-focused, high binge scores |
| 🔍 **Discovery** | Off-the-beaten-path recommendations |

### Advanced Options

- **Genre Weights**: Fine-tune your preferences (1-5 scale per genre)
- **Novelty Bias**: Slide between timeless classics ↔ new releases
- **Popularity Bias**: Slide between hidden gems ↔ mainstream hits
...
```
┌────────────────────────────────────────────────────────────────────┐
│                     Watchwyrd Architecture                          │
├────────────────────────────────────────────────────────────────────┤
│                                                                    │
│   ┌─────────┐    ┌──────────────┐    ┌─────────────────┐          │
│   │ Stremio │───▶│  Watchwyrd   │───▶│  Gemini API     │          │
│   │   App   │◀───│    Server    │◀───│  (Your Key)     │          │
│   └─────────┘    └──────────────┘    │   OR            │          │
│                         │            │  Perplexity AI  │          │
│                         ▼            └─────────────────┘          │
...
- ✅ **100% accurate IMDb IDs** - no hallucinated or wrong IDs
- ✅ **Correct posters and metadata** - directly from Cinemeta
- ✅ **Movies stay movies, series stay series** - content type validation
...
**[⬆ Back to Top](#-watchwyrd)**

Made with 💜 and a sprinkle of ✨ destiny

*May your watchlist never be empty* 🔮
