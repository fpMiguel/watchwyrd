    ...
    <div class="third-party-section">
      ...
      <div class="third-party-content" id="thirdPartyContent">
        <div class="privacy-note">
          ...
          <p><strong>Your API keys</strong> are encrypted (AES-256-GCM) and stored only in your personal addon URL. 
          They are never stored on any server. The server is fully stateless.</p>
        </div>
        
        <p style="margin: 1rem 0; color: var(--text-muted);">
          For complete details on third-party services, data handling, and privacy policies, see the
          <a href="https://github.com/fpMiguel/watchwyrd#-privacy--security" target="_blank" style="color: var(--accent);">
        ...
        <div class="credits-section">
          ...
          <p style="color: var(--text-muted); font-size: 0.85rem;">
            Stremio • Google Gemini • OpenAI • Perplexity • Open-Meteo • OpenStreetMap • RatingPosterDB • Cinemeta
          </p>
        </div>
      </div>
    </div>
